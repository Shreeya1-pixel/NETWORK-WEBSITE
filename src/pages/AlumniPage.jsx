...
/** One glass card: optional multiple feature blocks, each with bullets + benefit */
...
const studentCards = [
    {
        ...
        blocks: [
            {
                title: 'Project matching & course help',
                lines: [
                    'Finds teammates based on skills',
                    'Post doubts like “DSA301 trees—help!” and get quick answers from peers and alumni',
                ],
                benefit: 'Build better projects faster with fast, relevant academic help.',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                title: 'Opportunities & resume',
                lines: [
                    'Shows curated internships, jobs, and projects',
                    'Creates a professional CV automatically',
                ],
                benefit: 'No more random searching — save time and improve quality.',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                title: 'Skills & micro-quests',
                lines: [
                    'Trade skills with peers in skill swap markets',
                    'Small, quick tasks on micro-quest boards for experience',
                ],
                benefit: 'Learn without spending money; gain skills and earn rewards.',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                title: 'Clarity Points Marketplace',
                lines: [
                    'Earn credits by helping others',
                    'Use credits for perks or profile boosts',
                ],
                benefit: 'Help others → grow your own career.',
            },
        ],
    },
];
        ...
        blocks: [
            {
                ...
                lines: ['Connects alumni with students'],
                benefit: 'Personalized guidance from experienced people.',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                lines: ['Suggests relevant job opportunities'],
                benefit: 'Based on experience and your network.',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                title: 'Flash Reunion Pods',
                lines: ['Same-university chat groups for alumni'],
                benefit: 'Easy reconnecting without planning events.',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                title: 'Credibility & study remixes',
                lines: [
                    'Prof-verified badges: alumni verify student skills and work',
                    'Study group remixes: improve explainers and pass knowledge to newer batches',
                ],
                benefit: 'Trust, authority, and learning that evolves across generations.',
            },
        ],
    },
];
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="font-body text-secondary max-w-2xl mx-auto">
                            Students and alumni — everything in one place.
                        </p>
                    </motion.div>
                </div>
            </section>

            {/* Student features — 4 columns */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 items-stretch">
                        {alumniCards.map((card, index) => (
                            <FeatureBulletCard
                                ...
                                card={card}
                                index={index}
                                tintClass={tintClasses[(index + 2) % tintClasses.length]}
                            />
                        ))}
                    </div>
                </div>
